...
$routes->post('/', 'HomeController::findNit');
$routes->get('/calendar', 'HomeController::calendar');
$routes->post('/events', 'HomeController::events');
...
$routes->get('/table/companies/notification/(:segment)', 'HomeController::notification/$1');
$routes->post('created/notify', 'HomeController::created_notification');
$routes->post('updated/company', 'HomeController::updated_company');

$routes->get('send/emails', 'HomeController::send_emails');
